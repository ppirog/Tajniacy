...
public class PolishLanguageStrategy extends LanguageStrategy {
    public PolishLanguageStrategy() {
        super(POLISH_WORDS_FILE_PATH, RED_TEAM_INFO_POLISH, BLUE_TEAM_INFO_POLISH, GAME_OVER_INFO_POLISH, RED_LABEL_TEXT_POLISH, BLUE_LABEL_TEXT_POLISH, INSTRUCTION_LABEL_TEXT_POLISH);
    }
